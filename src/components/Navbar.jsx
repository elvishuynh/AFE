...
const servicesItems = [
    ...
    { label: 'Ceramic Coating', link: '/ceramic-coat' },
    ...
    return (
        <div className="flex flex-col items-center w-full sticky top-0 z-[999] bg-black">
            <div className="w-full flex justify-center py-4 bg-black">
                <img src="/AFE.webp" alt="AFE Logo" className="w-36 h-auto" />
            </div>
            <div ref={navbarRef} className="navbar sticky top-0 w-full flex justify-between items-center px-4 py-1 z-[999] bg-black transition-all ease-out duration-500" style={{ height: '60px' }}>
                <div className="links hidden md:flex justify-center font-azo-sans font-normal text-white flex-1">
                ...
                <div className="hidden md:flex items-center gap-4 pr-6 flex-1">
                    ...
                    <a href="tel:3103460336" className="text-white hover:text-red-500 transition-colors font-semibold text-base">
                        (310) 346-0336
                    </a>
                </div>
