...
const About = () => {
    ...
    return (
        <section id="about" className="container mx-auto px-6 md:px-12 lg:px-24 xl:px-48 border-t border-white/10">
            <h1 ref={titleRef} id="about-title" className="text-4xl sm:text-5xl md:text-6xl font-azo-sans font-bold py-8 text-center">
                About Us
            </h1>
            ...
            <section id="about-why-choose" className="mt-16">
                <h2 ref={chooseRef} id="about-why-title" className="text-2xl sm:text-3xl md:text-4xl font-azo-sans font-bold text-center">Why Choose Auto Film Experts?</h2>
                <div id="about-why-content" className="mx-auto px-8 py-12 xl:py-24 max-w-screen-2xl text-center">
                    <div id="about-why-gallery" className="mt-12 lg:gap-y-16 flex flex-col gap-y-8">
                        <div id="about-garage">
