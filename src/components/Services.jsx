      ...
      <div className="space-y-8 p-4 md:p-8">
        <section className="flex flex-col md:flex-row-reverse items-center space-y-4 md:space-y-0 md:space-x-4 p-4">
          ...
          <div className="reveal flex-none w-full md:w-1/2">
            <img ref={imageRef1} src="./DSC02028.webp" alt="Paint Protection Film" className="object-scale-down max-h-96 w-full md:w-9/12 rounded-lg shadow-lg mx-auto" />
          </div>
        </section>
        ...
        <section className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 p-4">
          ...
          <div className="reveal flex-none w-full md:w-1/2">
            <img ref={imageRef2} src="./image1.webp" alt="Ceramic Coating" className="max-h-96 max-h-96 w-full md:w-9/12 rounded-lg shadow-lg mx-auto" />
          </div>
        </section>

        <section className="flex flex-col md:flex-row-reverse items-center space-y-4 md:space-y-0 md:space-x-4 p-4">
          <div className="flex-1 text-center md:text-left">
            <Link to="/paint-correction"><h1 ref={paintCorrectionRef} className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-azo-sans font-bold py-8 text-center" style={{ wordBreak: "keep-all" }}>Paint Correction</h1></Link>
            <p className="text-gray-400 text-sm sm:text-base md:text-xl">
          ...
          <div className="reveal flex-none w-full md:w-1/2">
            <img ref={imageRef3} src="./shop2.webp" alt="Paint Correction" className="object-scale-down max-h-96 w-full md:w-9/12 rounded-lg shadow-lg mx-auto" />
          </div>
        </section>
        ...
        <section className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 p-4">
          ...
          <div className="reveal flex-none w-full md:w-1/2">
            <img ref={imageRef4} src="./image2.webp" alt="Window Tinting" className="max-h-96 w-full md:w-9/12 rounded-lg shadow-lg mx-auto" />
          </div>
        </section>
      </div>
    </div>
