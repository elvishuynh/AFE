            ...
            <div className="space-y-8 p-4 md:p-8">
                <section className="flex flex-col md:flex-row-reverse items-center space-y-4 md:space-y-0 md:space-x-4 p-4">
                    <div className="flex-1 text-center md:text-left">
                        <h1 ref={titleRef} className="text-5xl font-azo-sans font-bold py-8 text-center ">Paint Protection Film</h1>
                ...
                <section className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 p-4">
                    <div className="flex-1 text-center md:text-right">
                        <h1 ref={ceramicCoatingRef} className="text-5xl font-azo-sans font-bold py-8 text-center ">Ceramic Coating</h1>
                        <p className="text-gray-600">
                ...
                <section className="flex flex-col md:flex-row-reverse items-center space-y-4 md:space-y-0 md:space-x-4 p-4">
                    <div className="flex-1 text-center md:text-left">
                        <h1 ref={paintCorrectionRef} className="text-5xl font-azo-sans font-bold py-8 text-center ">Paint Correction</h1>
                        <p className="text-gray-600">
                ...
                <section className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 p-4">
                    <div className="flex-1 text-center md:text-right">
                        <h1 ref={windowTintingRef} className="text-5xl font-azo-sans font-bold py-8 text-center ">Window Tinting</h1>
                        <p className="text-gray-600">
