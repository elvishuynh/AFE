                ...
                <div className="py-0 sm:py-32 lg:pb-40">
                    <div className="mx-auto px-6 max-w-screen-2xl">
                        ...
                        <div className="mt-10 sm:mt-5 lg:px-32">
                            <img ref={imgRef}
                                src="/DSC02028.webp" alt="App screenshot" className="drop-shadow-2xl w-full h-auto rounded-md shadow-white object-scale-down max-h-screen w-full rounded-lg mx-auto"/>
                        </div>
                    </div>
