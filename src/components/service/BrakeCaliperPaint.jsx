                ...
                <div className="py-0 sm:py-32 lg:pb-40">
                    <div className="mx-auto px-6 max-w-screen-2xl">
                        <div className="mx-auto text-center max-w-2xl">
                            ...
                            <p ref={titleRef2} lineheight="8" className="mt-6 text-lg text-gray-300">Brake caliper paint enhances the appearance of your vehicle's brake calipers while providing protection against rust, corrosion, and high temperatures.</p>
                            <div className="mt-10 items-center justify-center flex gap-x-6">
                                <a ref={titleRef1} href="/contact" className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm
                                    ...
                                    focus-visible:outline-gray-900 my-8">Customize Your Calipers</a>
                            </div>
                            <div className="mt-8">
                                <ServiceContactCard />
                            </div>
                            ...
                            <div className="mt-12 lg:gap-y-16 flex flex-col gap-y-8">
                                <dl className="pt-12 md:grid-cols-3 lg:gap-36 text-lg border-t border-white/10 grid grid-cols-1 gap-12">
                                    <div>
                                        ...
                                        <dd className="mt-4 text-base text-gray-300">Painting your brake calipers adds a pop of color and a sporty look to your vehicle, enhancing its overall appearance and making it stand out.</dd>
                                    </div>
                                    <div>
                                        <dt className="items-center inline-flex gap-4">
                                            <p lineheight="6" className="text-base font-medium text-white">Rust and Corrosion Protection</p>
                                        </dt>
                                        <dd className="mt-4 text-base text-gray-300">The paint acts as a protective barrier against rust and corrosion, extending the life of your brake calipers by preventing damage from moisture and road salt.</dd>
                                    </div>
                                    <div>
                                        <dt className="items-center inline-flex gap-4">
                                            <p lineheight="6" className="text-base font-medium text-white">Heat Resistance</p>
                                        </dt>
                                        <dd className="mt-4 text-base text-gray-300">Brake caliper paint is specially formulated to withstand the high temperatures generated by braking, ensuring that the color remains vibrant and does not peel or discolor over time.</dd>
                                    </div>
                                </dl>
                                <dl className="pt-12 lg:gap-36 md:grid-cols-3 text-lg border-t border-white/10 grid grid-cols-1 gap-12">
                                    <div>
                                        ...
                                        <dd className="mt-4 text-base text-gray-300">Advanced formulations that include ceramic resins and heat-resistant compounds. This technology ensures superior adhesion, long-lasting color retention, and resistance to chipping and fading, even under extreme braking conditions.</dd>
                                    </div>
                                    <div>
                                        <dt className="items-center inline-flex gap-4">
                                            <p lineheight="6" className="text-base font-medium text-white">Easy Maintenance</p>
                                        </dt>
                                        <dd className="mt-4 text-base text-gray-300">Painted calipers are easier to clean and maintain compared to unpainted ones, as the smooth painted surface repels brake dust and grime more effectively.</dd>
                                    </div>
                                    <div>
                                        <dt className="items-center inline-flex gap-4">
                                            <p lineheight="6" className="text-base font-medium text-white">Customizable Appearance</p>
                                        </dt>
                                        <dd className="mt-4 text-base text-gray-300">Available in a variety of colors and finishes, brake caliper paint allows you to personalize your vehicle’s look to match your style or the overall design theme of your car.</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-8 gap-3">
                        <a href="/contact" className="rounded-md bg-red-600 hover:bg-red-700 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-colors">Customize Your Calipers</a>
